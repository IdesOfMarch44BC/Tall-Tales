...
**Coins** are Rings — the Concord’s neutral metal, good everywhere, heavy in the pocket. **Funds** are promises: scrip, letters of draw, banked credit, a factor’s goodwill — worth their issuer’s health, subject to the spread, and how anything expensive actually moves. The tables below price honest gear in Rings; anything marked **(F)** is a Funds purchase — a negotiation, a relationship, and a paper trail, not a transaction.
...
Each class starts with its kit and **10 Rings**:
...
| Spyglass | 8 | **Frame chassis** (light) | 200 (F) |
| Manacles, Guild-marked | 3 | **Frame chassis** (draft) | 450 (F) |
...
| Sawbone care, per wound step reduced | 3 | Downtime; halved at a Guild hall |
